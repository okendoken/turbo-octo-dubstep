...
class ThingsControllerTest < ActionController::TestCase
  ...
  test "should create thing" do
    assert_difference('Thing.count') do
      post :create, thing: { description: @thing.description, given: @thing.given, name: @thing.name, user_id: @thing.user_id }
    end
  ...
  test "should update thing" do
    patch :update, id: @thing, thing: { description: @thing.description, given: @thing.given, name: @thing.name, user_id: @thing.user_id }
    assert_redirected_to thing_path(assigns(:thing))
  end
